  ...
  return (
    ...
    <List sx={{ width: '100%',maxWidth: 820, bgcolor: 'background.paper' }}>
      ...
      <ListItem alignItems="flex-start">
        ...
        />
        <ListItemIcon onClick={() => handleRemoveBook(book)} sx={{ cursor: 'pointer' }}>
          <PlaylistRemoveIcon />
        </ListItemIcon>
      </ListItem>
      ...
      ): ( <div className='w-full h-screen flex justify-center items-center text-semibold text-primary'>Reading list is currently empty</div> )}
    </List>
    </Box>
  );
}
